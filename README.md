# nvim-treesitter-queries-twig

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-twig/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-twig/actions/workflows/validate.yml)

Neovim tree-sitter queries for **twig**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-twig",
...
- [ ] Changes are scoped to `twig` — do not include files for other languages
